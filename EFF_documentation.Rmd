...
EFF are hypothesized to have best flows for salmon in our historical system

-   Our system is not highly managed so we may need to alter EFF slightly from their historical values to maximize benefit to salmon.
...
dry_year <- DSMflow::flows_cfs$biop_itp_2018_2019 |> 
  ...
  glimpse() 
dry_year |> 
  ggplot(aes(x = month, y = `Upper-mid Sacramento River`, group = 1)) + 
  geom_line()
